...
import testimonialsData from '../../../Component/FileJson/Testimonials.json'; // Adjust the path if necessary
        ...
        <div className="bg-gray-100 p-8">
            ...
            <div className="flex flex-col md:flex-row">
                ...
                <div className="relative w-full md:w-1/3 overflow-hidden">
                    <iframe
                        src="https://lottie.host/embed/4762d34a-0d56-425a-882d-0a3e427d7e0a/bsCESMELVw.json"
