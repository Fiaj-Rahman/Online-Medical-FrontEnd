  ...
  return (
    <div className="bg-gray-100 py-12">
      ...
      <div className="container mx-auto flex flex-col md:flex-row justify-between items-center space-y-8 md:space-y-0">
        {/* Left side: Gallery with Carousel */}
        <div className="w-full md:w-1/2">
          <GalleryWithCarousel />
        </div>

        {/* Right side: Why Choose Us section */}
        <div className="w-full md:w-1/2 space-y-6 px-6 md:px-12">
          <p className="text-lg text-gray-600">
            At <span className="text-blue-600 font-bold">MedConnect</span>, we are committed to providing accessible and
            high-quality healthcare. Here's why you should trust us with your health.
          </p>
          ...
          <section className="space-y-8">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-gray-800">Experienced Doctors</h3>
                <p className="text-gray-600">Our team consists of highly qualified doctors with years of experience in their respective fields.</p>
              </div>
            </div>
